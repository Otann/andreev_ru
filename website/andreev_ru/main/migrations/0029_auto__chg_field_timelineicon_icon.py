...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TimelineIcon.icon'
        db.alter_column('main_timelineicon', 'icon', self.gf('django.db.models.fields.files.FileField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'TimelineIcon.icon'
        db.alter_column('main_timelineicon', 'icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
