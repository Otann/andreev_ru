...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.occupation'
        db.add_column('main_person', 'occupation',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024),
                      keep_default=False)

        # Adding field 'Person.occupation_ru'
        db.add_column('main_person', 'occupation_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.occupation_en'
        db.add_column('main_person', 'occupation_en',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.occupation'
        db.delete_column('main_person', 'occupation')

        # Deleting field 'Person.occupation_ru'
        db.delete_column('main_person', 'occupation_ru')

        # Deleting field 'Person.occupation_en'
        db.delete_column('main_person', 'occupation_en')
