...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'About.bio'
        db.delete_column('main_about', 'bio')

        # Adding field 'About.title_ru'
        db.add_column('main_about', 'title_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'About.title_en'
        db.add_column('main_about', 'title_en',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'About.description'
        db.add_column('main_about', 'description',
                      self.gf('ckeditor.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'About.description_ru'
        db.add_column('main_about', 'description_ru',
                      self.gf('ckeditor.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'About.description_en'
        db.add_column('main_about', 'description_en',
                      self.gf('ckeditor.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'About.bio'
        db.add_column('main_about', 'bio',
                      self.gf('ckeditor.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'About.title_ru'
        db.delete_column('main_about', 'title_ru')

        # Deleting field 'About.title_en'
        db.delete_column('main_about', 'title_en')

        # Deleting field 'About.description'
        db.delete_column('main_about', 'description')

        # Deleting field 'About.description_ru'
        db.delete_column('main_about', 'description_ru')

        # Deleting field 'About.description_en'
        db.delete_column('main_about', 'description_en')
