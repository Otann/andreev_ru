...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_work', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Work.thumb'
        db.add_column('main_work', 'thumb',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('main_work', 'image')

        # Deleting field 'Work.thumb'
        db.delete_column('main_work', 'thumb')
