...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'News.pub_date'
        db.alter_column('main_news', 'pub_date', self.gf('django.db.models.fields.DateTimeField')())
        # Deleting field 'Work.release_year'
        db.delete_column('main_work', 'release_year')

        # Adding field 'Work.build_start'
        db.add_column('main_work', 'build_start',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 1, 23, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Work.build_finish'
        db.add_column('main_work', 'build_finish',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 1, 23, 0, 0), blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'News.pub_date'
        db.alter_column('main_news', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        ...
        # Deleting field 'Work.build_start'
        db.delete_column('main_work', 'build_start')

        # Deleting field 'Work.build_finish'
        db.delete_column('main_work', 'build_finish')
    ...
    models = {
        ...
        'main.work': {
            ...
            'build_finish': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
            'build_start': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
