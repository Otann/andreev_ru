...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CustomString'
        db.create_table('main_customstring', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('value_ru', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('value_en', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=1024)),
        ))
        db.send_create_signal('main', ['CustomString'])

        # Adding model 'CustomPage'
        db.create_table('main_custompage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('title_ru', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('title_en', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
    ...
    def backwards(self, orm):
        # Deleting model 'CustomString'
        db.delete_table('main_customstring')
