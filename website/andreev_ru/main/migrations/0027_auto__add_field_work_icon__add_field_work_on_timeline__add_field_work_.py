...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Work.icon'
        db.add_column('main_work', 'icon',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Work.on_timeline'
        db.add_column('main_work', 'on_timeline',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Work.timeline_position'
        db.add_column('main_work', 'timeline_position',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Work.icon'
        db.delete_column('main_work', 'icon')

        # Deleting field 'Work.on_timeline'
        db.delete_column('main_work', 'on_timeline')

        # Deleting field 'Work.timeline_position'
        db.delete_column('main_work', 'timeline_position')
    ...
    models = {
        ...
        'main.work': {
            ...
            'on_timeline': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'timeline_position': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
