...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_person', (
            ...
            ('position', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.PersonPosition'])),
        ))
    ...
    models = {
        ...
        'main.person': {
            ...
            'position': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.PersonPosition']"})
        },
        'main.personposition': {
