...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Work.client_ru'
        db.add_column('main_work', 'client_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Work.client_en'
        db.add_column('main_work', 'client_en',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Work.client_ru'
        db.delete_column('main_work', 'client_ru')

        # Deleting field 'Work.client_en'
        db.delete_column('main_work', 'client_en')
