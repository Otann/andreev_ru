...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('main_work', 'square', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Work.build_start'
        db.alter_column('main_work', 'build_start', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Work.build_finish'
        db.alter_column('main_work', 'build_finish', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Work.square'
        db.alter_column('main_work', 'square', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'Work.build_start'
        db.alter_column('main_work', 'build_start', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 1, 23, 0, 0)))

        # Changing field 'Work.build_finish'
        db.alter_column('main_work', 'build_finish', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 1, 23, 0, 0)))
